...
### Fixed
- Abort STA connect/reconnect before Wi-Fi scan so `Scan failed to start` stops looping.
- Pause auto-reconnect on Disconnect STA; add `clear_sta` to wipe bad saved credentials.
- Longer GPIO2 LED celebrate pulses and a dashboard **Blink LED** control.

## [1.0.4] - 2026-07-26

### Added
- Full-page USB dashboard route (`#/dashboard`) with Claude-inspired light theme and theme switcher.
- Live SVG atmosphere art, white action buttons, and theme switcher.
